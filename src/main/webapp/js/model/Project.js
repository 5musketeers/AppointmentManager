var Project = function(data){
	...
	self.getHtml = function(template){
		var templates = {
				'row': '<tr class="project" data-id="'+self.id+'">\
					<td>'+self.name+'</td>\
					<td><input type="button" class="edit btn" value="Edit" data-type="project" /> <input type="button" class="delete btn btn-danger" value="Delete" data-type="project" /></td>\
				</tr>',
				'form': '<form name="reg" data-ajax="false" role="form" id="projectForm"  data-id="'+self.id+'">\
				            <fieldset>\
...
Project.list = function(tableToAppend, template){
	...
	$.ajax({
        ...
        success: function(data) {
        	...
        	Project.allData = {};
        	for(var d in data){
        		var app = new Project(data[d]);
        		Project.allData[app.id] = app;
